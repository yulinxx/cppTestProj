/**
 * @file point_set_2d.cpp
 * @brief CGAL 2D 点云处理示例
 * 
 * 2D 点云处理是处理二维点数据的技术
 * 主要功能：
 * 1. 点云采样
...
{
    std::cout << "========================================" << std::endl;
    std::cout << "   CGAL 2D 点云处理示例" << std::endl;
    std::cout << "========================================" << std::endl;

    // ==================== 示例1: 创建 2D 点云 ====================
    std::cout << "\n=== 示例1: 创建 2D 点云 ===" << std::endl;
    ...
    std::cout << "生成了 100 个随机点（在 -10 到 10 的正方形内）" << std::endl;
    ...
    std::cout << "\n========================================" << std::endl;
    std::cout << "   2D 点云处理示例运行完成！" << std::endl;
    std::cout << "========================================" << std::endl;
