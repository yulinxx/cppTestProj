...
namespace
{
    ...
    struct playerSM : public msm::front::state_machine_def<playerSM>
    {
        ...
        struct EmptyState : public msm::front::state<>
        {
            ...
            void open_drawer(open_closeEvent const&)
            {
                std::cout << "EmptyState::open_drawer\n";
            }
            // actions for EmptyState's internal transitions
            void internal_action(cd_detected const&)
            {
                std::cout << "EmptyState::internal action\n";
            }
        ...
        struct OpenState : public msm::front::state<>
        {
            ...
            void on_exit(Event const&, FSM&)
            {
                std::cout << "leaving: OpenState" << std::endl;
            }
            void close_drawer(open_closeEvent const&)
            {
                std::cout << "OpenState::close_drawer\n";
            }
            void stop_and_open(open_closeEvent const&)
            {
                std::cout << "OpenState::stop_and_open\n";
            }
        };
        ...
        struct StoppedState : public msm::front::state<msm::front::default_base_state, msm::front::sm_ptr>
        {
            ...
            void on_exit(Event const&, FSM&)
            {
                std::cout << "leaving: StoppedState" << std::endl;
            }
            ...
            playerSM* m_player;
            void start_playback(playEvent const&)
            {
                std::cout << "StoppedState::start_playback\n";
            }
            void stop_playback(stopEvent const&)
            {
                std::cout << "StoppedState::stop_playback\n";
            }
        };
        ...
        struct PlayingState : public msm::front::state<>
        {
            ...
            void on_exit(Event const&, FSM&)
            {
                std::cout << "leaving: PlayingState" << std::endl;
            }
            // guard conditions
        ...
        {
            void pause_playback(pauseEvent const&)
            {
                std::cout << "PausedState::pause_playback\n";
            }
            void resume_playback(end_pauseEvent const&)
            {
                std::cout << "PausedState::resume_playback\n";
            }
        };

        //////////////////////////////////////////////////////////////////////
        // action
        void store_cd_infoAct(cd_detected const&)
        {
            std::cout << "Player::store_cd_infoAct\n";
        }
