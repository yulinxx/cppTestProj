...
namespace A
{
    ...
    struct Test<int, T>
    {
        Test(int, T) { std::cout << "Test<int, T>" << std::endl; }
        static void f();
    };
...
namespace C
{
    void f(int a, int b) { std::cout << "f a" << std::endl; } // 重载函数

    template <typename T1, typename T2>
    void f(T1 a, T2 b) { std::cout << "f b" << std::endl; }; // 通用模板

    template <>
    void f<int, int>(int a, int b) { std::cout << "f c" << std::endl; } // 全特化
...
namespace D
{
    ...
    struct Test<Tool<T>>
    {
        Test() { std::cout << "Test<Tool<T>>" << std::endl; }
    }; // 【1】偏特化
...
namespace E
{
    ...
    {
        Test() { std::cout << "Test<Tool<T1, T2>>" << std::endl; }
    }; // 【1】偏特化模板

    template <typename T>
    struct Test<Tool<int, T>>
    {
        Test() { std::cout << "Test<Tool<int, T>>>" << std::endl; }
    }; // 【2】偏特化模板
